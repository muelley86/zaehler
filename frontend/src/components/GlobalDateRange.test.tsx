...
describe('GlobalDateRange', () => {
  it('zeigt das volle Jahr kompakt und springt mit den Pfeilen um ganze Jahre', () => {
  ...
  it('ändert den Bereich über das von/bis-Popover (Label wird zur Kurzform)', () => {
    renderWithRouter(<GlobalDateRange variant="sidebar" />);
    ...
    expect(screen.getByText('01.03.–31.12.2026')).toBeInTheDocument();
  });
});
